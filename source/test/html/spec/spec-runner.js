  ...
  LivePad.prototype.returnInstrumentTableData = function() {
    ...
    instrumentTable = this.kitCollection.map((function(_this) {
      return function(kit) {
        ...
        instruments = _.where(instruments, {
          dropped: false
        });
        return {
          label: kit.get('label'),
