...
LivePad = (function(_super) {
  ...
  LivePad.prototype.onPadSquareDraggingStart = function(params) {
    var $padSquare;
    $padSquare = params.$padSquare;
    return console.log($padSquare);
  };
