...
LivePad = (function(_super) {
  ...
  LivePad.prototype.onDroppedChange = function(instrumentModel) {
    ...
    return console.log(instrumentId, padSquareId, $padSquare.length, padSquareModel);
  };
