...
LivePad = (function(_super) {
  ...
  LivePad.prototype.onInstrumentDrop = function(dragged, dropped) {
    ...
    return instrumentModel.set('dropped', true);
  };
