...
PadSquare = (function(_super) {
  ...
  PadSquare.prototype.onRelease = function(event) {
    return clearTimeout(this.dragTimeout);
  };
  ...
  PadSquare.prototype.onDraggingChange = function(model) {
    var dragging;
    return dragging = model.changed.dragging;
  };
