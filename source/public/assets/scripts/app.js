  ...
  AppRouter.prototype.sequencerRoute = function() {
    ...
    _(6).times((function(_this) {
      return function() {
        ...
        return squareCollections.push(new PatternSquareCollection(squares));
      };
    })(this));
